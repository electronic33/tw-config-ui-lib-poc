  ...
  return (
    <div className="flex space-x-4">
      <div className="flex flex-col space-y-4 items-start">
        ...
        <Button className="btn-size-md btn-color-primary-filled">
          <FaAirbnb className="btn-icon-left-md" />
          Button MD
        </Button>
        <Button className="btn-size-md btn-color-primary-filled w-56">
          <FaAirbnb className="btn-icon-left-md btn-icon-left-md-offset-to-center" />
          Button MD
        </Button>
        <Button className="btn-size-md btn-color-primary-filled">
          Button MD
          <FaAirbnb className="btn-icon-right-md" />
        </Button>
        <Button className="btn-size-md btn-color-primary-filled w-56">
          Button MD
          <FaAirbnb className="btn-icon-right-md btn-icon-right-md-offset-to-center" />
        </Button>
        <Button className="btn-size-lg btn-color-primary-filled" disabled>
          Button LG
        </Button>
